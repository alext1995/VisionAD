...
from algos.msflow._defaultconfigs import msflow_default_model_params
image_size = 256

model_list = []
model_list.append({"algo_class_name": "msflow", 
                    "model_params": msflow_default_model_params,
                    "epochs": 100,
                    ...
                    "device": "cuda:0",
                    "input_size": 256,
                    "model_description": "msflow model", # description saved to each run from the dictionary - DIFFERENT to run_description in the cmd, which is the description attached to all the runs in a given config file - use no more than 20 characters - used in the results directory name
