...
model_list.append({"algo_class_name": "fastflow2d", 
                    "model_params": fastflow_default_model_params,
                    "epochs": 500,
                    ...
                    "device": "cuda:0",
                    "input_size": 256,
                    "model_description": "fastflow model", # description saved to each run from the dictionary - DIFFERENT to run_description in the cmd, which is the description attached to all the runs in a given config file - use no more than 20 characters - used in the results directory name
