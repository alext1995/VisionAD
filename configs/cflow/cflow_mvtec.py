...
model_list = [{"algo_class_name": "cflow", 
                "model_params": cflow_default_model_params,
                "epochs": 200,
                ...
                "device": "cuda:0",
                "input_size": 256,
                "model_description": "cflow model", # description saved to each run from the dictionary - DIFFERENT to run_description in the cmd, which is the description attached to all the runs in a given config file - use no more than 20 characters - used in the results directory name
